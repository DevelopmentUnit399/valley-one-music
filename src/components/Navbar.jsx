...
export const ADMIN_EMAIL = 'garrettuichanco@att.net'
    ...
    return (
        <div className="w-full flex justify-between items-center font-semibold relative">
            ...
            {!authLoading && (
                <div>
                    {currentUser ? (
                        /* Logged In View: Admin Badge + Profile Dropdown */
                        <div className="relative flex items-center gap-2" ref={menuRef}>
                            {isAdmin && (
                                <a 
                                    ...
                                    className="flex items-center gap-1 bg-emerald-500/15 hover:bg-emerald-500/25 active:scale-95 border border-emerald-500/30 text-emerald-400 text-[11px] font-bold px-2 py-0.5 rounded-full select-none transition-all cursor-pointer"
                                >
                                    <svg 
                        ...
                        /* Logged Out View: Sign Up & Log In Buttons */
                        <div className="flex items-center gap-3">
                            <button
                                onClick={() => navigate('/signup')}
                                className="text-zinc-400 hover:text-white font-semibold text-xs sm:text-sm px-3 py-1.5 transition-colors cursor-pointer"
                            >
                                Sign up
                            </button>
                            <button
                                onClick={() => navigate('/login')}
                                className="bg-white hover:bg-zinc-200 text-black font-bold text-xs sm:text-sm px-5 py-2 rounded-full transition-transform hover:scale-105 active:scale-95 cursor-pointer shadow-md"
                            >
                                Log in
                            </button>
                        </div>
